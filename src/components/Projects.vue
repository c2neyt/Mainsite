...
const projects = ['c2neyt.github.io', 'Mainsite', 'ne22', 'camilosite']
const repos = ref([]);

onMounted(async () => {
  await fetch('https://api.github.com/users/c2neyt/repos')
...
<template>
  <div class="mb-2 font-black text-2xl">projeler/</div>
  <div class="grid md:grid-cols-2 gap-2">
    <div v-if="!repos.length">projelere ulaşılamadı.</div>
